...
function StatusBadge() {
  return (
    <motion.div
      ...
      className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/20 bg-cyan-500/5 text-xs font-medium text-cyan-300 mb-8"
    >
...
export default function Hero() {
  return (
    ...
    >
      {/* Background orbs */}
      <div className="orb w-[600px] h-[600px] bg-cyan-600/10 -top-48 -right-48" />
      <div className="orb w-[500px] h-[500px] bg-purple-600/10 -bottom-32 -left-32" style={{ animationDelay: "3s" }} />
      <div className="orb w-[300px] h-[300px] bg-blue-600/8 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ animationDelay: "6s" }} />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 text-center">
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl mx-auto text-slate-400 text-base sm:text-lg leading-relaxed"
        >
